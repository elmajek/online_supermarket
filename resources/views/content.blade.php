...
#whats-chat{position:fixed;right:1%;bottom:10%;height:auto;width:auto;background:#25D366;padding:8.5px;border-radius:50px;}
...
var relmsg = msg.replace(/ /g,"%20");
 window.open('https://api.whatsapp.com/send?phone=01012684496&text='+relmsg,'_blank');
